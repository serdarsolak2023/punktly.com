...
<main className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-amber-50 px-4 py-6 md:px-6">
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-sky-100 via-white to-amber-100 p-4 pb-28 md:p-8 md:pb-32">
      {celebration && (
                ...
                <section className="grid gap-5 lg:grid-cols-2">
                  <Panel title={editingTaskId ? "✏️ Aufgabe bearbeiten" : "➕ Aufgabe anlegen"}>
                    ...
                    <div className="grid gap-3">
                      ...
                      <input value={newTaskCoins} onChange={e => setNewTaskCoins(Number(e.target.value))} type="number" placeholder="Coins anpassen" className="w-full rounded-[1.35rem] border p-3" />
              ...
              {parentView === "rewards" && (
                <section className="grid gap-5 lg:grid-cols-2">
                  <Panel title={editingRewardId ? "✏️ Belohnung bearbeiten" : "🎁 Belohnung anlegen"}>
                    ...
                    <div className="grid gap-3"><input value={newRewardTitle} onChange={e => setNewRewardTitle(e.target.value)} placeholder="Belohnung, z. B. Eis" className="w-full rounded-[1.35rem] border p-3" /><input value={newRewardCoins} onChange={e => setNewRewardCoins(Number(e.target.value))} type="number" placeholder="Coins" className="w-full rounded-[1.35rem] border p-3" /><button onClick={saveReward} className="rounded-[1.35rem] bg-purple-500 px-4 py-3 font-black text-white">{editingRewardId ? "Änderung speichern" : "Belohnung hinzufügen"}</button></div>
                  </Panel>
                  ...
                  <Panel title={editingShopId ? "✏️ Shop-Produkt bearbeiten" : "🛒 Shop-Produkt anlegen"}>
                    ...
                    <div className="grid gap-3">
                      <input
                        ...
                        placeholder="Produkt, z. B. Spiel, Unternehmungen, Reisen ..."
                      ...
                      <textarea
                        ...
                        placeholder="Beschreibung, z. B. wann das Produkt gekauft werden kann"
